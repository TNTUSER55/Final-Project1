    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (salery >= 1) //make sure salary is positive
                {
                    ...
                    MessageBox.Show("Enter a positive salary");
        ...
        private void Submit_Click(object sender, EventArgs e)
        {
            ...
            //need to stop name[counter] from accepting numeric string input and passing it on
